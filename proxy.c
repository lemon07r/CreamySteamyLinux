...
/* Forward pointers */
__attribute__((visibility("hidden"))) void *_fwd_GetHSteamPipe = NULL;
__attribute__((visibility("hidden"))) void *_fwd_GetHSteamUser = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_gameserveritem_t_Construct = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_gameserveritem_t_GetName = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_gameserveritem_t_SetName = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_GetHSteamPipe = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_GetHSteamUser = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_GetSteamInstallPath = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_InitAnonymousUser = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_InitFlat = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_InitSafe = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_IsSteamRunning = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamApps_BIsCybercafe = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamApps_BIsLowViolence = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamApps_BIsSubscribedFromFamilySharing = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamApps_BIsSubscribedFromFreeWeekend = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamApps_BIsTimedTrial = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamApps_BIsVACBanned = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamApps_GetAppBuildId = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamApps_GetAppInstallDir = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamApps_GetAppOwner = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamApps_GetAvailableGameLanguages = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamApps_GetBetaInfo = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamApps_GetCurrentBetaName = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamApps_GetCurrentGameLanguage = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamApps_GetDlcDownloadProgress = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamApps_GetFileDetails = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamApps_GetInstalledDepots = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamApps_GetLaunchCommandLine = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamApps_GetLaunchQueryParam = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamApps_GetNumBetas = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamApps_InstallDLC = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamApps_MarkContentCorrupt = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamApps_RequestAllProofOfPurchaseKeys = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamApps_RequestAppProofOfPurchaseKey = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamApps_SetActiveBeta = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamApps_SetDlcContext = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamApps_UninstallDLC = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamClient_BReleaseSteamPipe = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamClient_BShutdownIfAllPipesClosed = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamClient_ConnectToGlobalUser = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamClient_CreateLocalUser = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamClient_CreateSteamPipe = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamClient_GetIPCCallCount = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamClient_GetISteamApps = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamClient_GetISteamController = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamClient_GetISteamFriends = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamClient_GetISteamGameSearch = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamClient_GetISteamGameServer = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamClient_GetISteamGameServerStats = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamClient_GetISteamGenericInterface = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamClient_GetISteamHTMLSurface = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamClient_GetISteamHTTP = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamClient_GetISteamInput = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamClient_GetISteamInventory = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamClient_GetISteamMatchmaking = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamClient_GetISteamMatchmakingServers = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamClient_GetISteamMusic = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamClient_GetISteamMusicRemote = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamClient_GetISteamNetworking = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamClient_GetISteamParentalSettings = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamClient_GetISteamParties = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamClient_GetISteamRemotePlay = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamClient_GetISteamRemoteStorage = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamClient_GetISteamScreenshots = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamClient_GetISteamUGC = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamClient_GetISteamUser = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamClient_GetISteamUserStats = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamClient_GetISteamUtils = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamClient_GetISteamVideo = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamClient_ReleaseUser = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamClient_SetLocalIPBinding = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamClient_SetWarningMessageHook = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamController_ActivateActionSet = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamController_ActivateActionSetLayer = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamController_DeactivateActionSetLayer = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamController_DeactivateAllActionSetLayers = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamController_GetActionOriginFromXboxOrigin = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamController_GetActionSetHandle = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamController_GetActiveActionSetLayers = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamController_GetAnalogActionData = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamController_GetAnalogActionHandle = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamController_GetAnalogActionOrigins = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamController_GetConnectedControllers = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamController_GetControllerBindingRevision = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamController_GetControllerForGamepadIndex = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamController_GetCurrentActionSet = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamController_GetDigitalActionData = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamController_GetDigitalActionHandle = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamController_GetDigitalActionOrigins = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamController_GetGamepadIndexForController = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamController_GetGlyphForActionOrigin = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamController_GetGlyphForXboxOrigin = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamController_GetInputTypeForHandle = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamController_GetMotionData = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamController_GetStringForActionOrigin = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamController_GetStringForXboxOrigin = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamController_Init = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamController_RunFrame = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamController_SetLEDColor = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamController_ShowBindingPanel = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamController_Shutdown = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamController_StopAnalogActionMomentum = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamController_TranslateActionOrigin = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamController_TriggerHapticPulse = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamController_TriggerRepeatedHapticPulse = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamController_TriggerVibration = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_ActivateGameOverlay = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_ActivateGameOverlayInviteDialog = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_ActivateGameOverlayInviteDialogConnectString = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_ActivateGameOverlayRemotePlayTogetherInviteDialog = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_ActivateGameOverlayToStore = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_ActivateGameOverlayToUser = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_ActivateGameOverlayToWebPage = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_BHasEquippedProfileItem = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_ClearRichPresence = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_CloseClanChatWindowInSteam = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_DownloadClanActivityCounts = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_EnumerateFollowingList = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetChatMemberByIndex = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetClanActivityCounts = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetClanByIndex = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetClanChatMemberCount = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetClanChatMessage = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetClanCount = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetClanName = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetClanOfficerByIndex = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetClanOfficerCount = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetClanOwner = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetClanTag = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetCoplayFriend = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetCoplayFriendCount = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetFollowerCount = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetFriendByIndex = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetFriendCoplayGame = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetFriendCoplayTime = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetFriendCount = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetFriendCountFromSource = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetFriendFromSourceByIndex = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetFriendGamePlayed = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetFriendMessage = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetFriendPersonaName = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetFriendPersonaNameHistory = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetFriendPersonaState = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetFriendRelationship = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetFriendRichPresence = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetFriendRichPresenceKeyByIndex = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetFriendRichPresenceKeyCount = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetFriendsGroupCount = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetFriendsGroupIDByIndex = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetFriendsGroupMembersCount = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetFriendsGroupMembersList = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetFriendsGroupName = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetFriendSteamLevel = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetLargeFriendAvatar = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetMediumFriendAvatar = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetNumChatsWithUnreadPriorityMessages = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetPersonaName = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetPersonaState = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetPlayerNickname = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetProfileItemPropertyString = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetProfileItemPropertyUint = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetSmallFriendAvatar = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_GetUserRestrictions = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_HasFriend = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_InviteUserToGame = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_IsClanChatAdmin = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_IsClanChatWindowOpenInSteam = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_IsClanOfficialGameGroup = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_IsClanPublic = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_IsFollowing = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_IsUserInSource = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_JoinClanChatRoom = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_LeaveClanChatRoom = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_OpenClanChatWindowInSteam = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_RegisterProtocolInOverlayBrowser = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_ReplyToFriendMessage = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_RequestClanOfficerList = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_RequestEquippedProfileItems = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_RequestFriendRichPresence = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_RequestUserInformation = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_SendClanChatMessage = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_SetInGameVoiceSpeaking = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_SetListenForFriendsMessages = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_SetPersonaName = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_SetPlayedWith = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamFriends_SetRichPresence = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameSearch_AcceptGame = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameSearch_AddGameSearchParams = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameSearch_CancelRequestPlayersForGame = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameSearch_DeclineGame = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameSearch_EndGame = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameSearch_EndGameSearch = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameSearch_HostConfirmGameStart = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameSearch_RequestPlayersForGame = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameSearch_RetrieveConnectionDetails = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameSearch_SearchForGameSolo = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameSearch_SearchForGameWithLobby = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameSearch_SetConnectionDetails = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameSearch_SetGameHostParams = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameSearch_SubmitPlayerResult = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServer_AssociateWithClan = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServer_BeginAuthSession = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServer_BLoggedOn = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServer_BSecure = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServer_BUpdateUserData = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServer_CancelAuthTicket = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServer_ClearAllKeyValues = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServer_ComputeNewPlayerCompatibility = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServer_CreateUnauthenticatedUserConnection = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServer_EndAuthSession = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServer_GetAuthSessionTicket = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServer_GetGameplayStats = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServer_GetNextOutgoingPacket = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServer_GetPublicIP = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServer_GetServerReputation = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServer_GetSteamID = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServer_HandleIncomingPacket = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServer_LogOff = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServer_LogOn = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServer_LogOnAnonymous = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServer_RequestUserGroupStatus = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServer_SendUserConnectAndAuthenticate_DEPRECATED = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServer_SendUserDisconnect_DEPRECATED = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServer_SetAdvertiseServerActive = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServer_SetBotPlayerCount = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServer_SetDedicatedServer = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServer_SetGameData = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServer_SetGameDescription = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServer_SetGameTags = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServer_SetKeyValue = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServer_SetMapName = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServer_SetMaxPlayerCount = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServer_SetModDir = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServer_SetPasswordProtected = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServer_SetProduct = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServer_SetRegion = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServer_SetServerName = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServer_SetSpectatorPort = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServer_SetSpectatorServerName = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServerStats_ClearUserAchievement = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServerStats_GetUserAchievement = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServerStats_GetUserStatFloat = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServerStats_GetUserStatInt32 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServerStats_RequestUserStats = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServerStats_SetUserAchievement = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServerStats_SetUserStatFloat = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServerStats_SetUserStatInt32 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServerStats_StoreUserStats = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServerStats_UpdateUserAvgRateStat = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServer_UserHasLicenseForApp = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamGameServer_WasRestartRequested = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTMLSurface_AddHeader = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTMLSurface_AllowStartRequest = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTMLSurface_CopyToClipboard = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTMLSurface_CreateBrowser = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTMLSurface_ExecuteJavascript = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTMLSurface_FileLoadDialogResponse = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTMLSurface_Find = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTMLSurface_GetLinkAtPosition = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTMLSurface_GoBack = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTMLSurface_GoForward = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTMLSurface_Init = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTMLSurface_JSDialogResponse = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTMLSurface_KeyChar = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTMLSurface_KeyDown = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTMLSurface_KeyUp = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTMLSurface_LoadURL = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTMLSurface_MouseDoubleClick = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTMLSurface_MouseDown = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTMLSurface_MouseMove = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTMLSurface_MouseUp = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTMLSurface_MouseWheel = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTMLSurface_OpenDeveloperTools = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTMLSurface_PasteFromClipboard = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTMLSurface_Reload = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTMLSurface_RemoveBrowser = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTMLSurface_SetBackgroundMode = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTMLSurface_SetCookie = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTMLSurface_SetDPIScalingFactor = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTMLSurface_SetHorizontalScroll = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTMLSurface_SetKeyFocus = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTMLSurface_SetPageScaleFactor = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTMLSurface_SetSize = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTMLSurface_SetVerticalScroll = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTMLSurface_Shutdown = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTMLSurface_StopFind = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTMLSurface_StopLoad = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTMLSurface_ViewSource = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTTP_CreateCookieContainer = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTTP_CreateHTTPRequest = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTTP_DeferHTTPRequest = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTTP_GetHTTPDownloadProgressPct = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTTP_GetHTTPRequestWasTimedOut = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTTP_GetHTTPResponseBodyData = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTTP_GetHTTPResponseBodySize = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTTP_GetHTTPResponseHeaderSize = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTTP_GetHTTPResponseHeaderValue = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTTP_GetHTTPStreamingResponseBodyData = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTTP_PrioritizeHTTPRequest = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTTP_ReleaseCookieContainer = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTTP_ReleaseHTTPRequest = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTTP_SendHTTPRequest = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTTP_SendHTTPRequestAndStreamResponse = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTTP_SetCookie = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTTP_SetHTTPRequestAbsoluteTimeoutMS = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTTP_SetHTTPRequestContextValue = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTTP_SetHTTPRequestCookieContainer = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTTP_SetHTTPRequestGetOrPostParameter = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTTP_SetHTTPRequestHeaderValue = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTTP_SetHTTPRequestNetworkActivityTimeout = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTTP_SetHTTPRequestRawPostBody = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTTP_SetHTTPRequestRequiresVerifiedCertificate = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamHTTP_SetHTTPRequestUserAgentInfo = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_ActivateActionSet = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_ActivateActionSetLayer = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_BNewDataAvailable = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_BWaitForData = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_DeactivateActionSetLayer = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_DeactivateAllActionSetLayers = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_EnableActionEventCallbacks = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_EnableDeviceCallbacks = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_GetActionOriginFromXboxOrigin = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_GetActionSetHandle = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_GetActiveActionSetLayers = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_GetAnalogActionData = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_GetAnalogActionHandle = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_GetAnalogActionOrigins = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_GetConnectedControllers = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_GetControllerForGamepadIndex = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_GetCurrentActionSet = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_GetDeviceBindingRevision = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_GetDigitalActionData = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_GetDigitalActionHandle = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_GetDigitalActionOrigins = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_GetGamepadIndexForController = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_GetGlyphForActionOrigin_Legacy = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_GetGlyphForXboxOrigin = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_GetGlyphPNGForActionOrigin = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_GetGlyphSVGForActionOrigin = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_GetInputTypeForHandle = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_GetMotionData = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_GetRemotePlaySessionID = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_GetSessionInputConfigurationSettings = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_GetStringForActionOrigin = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_GetStringForAnalogActionName = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_GetStringForDigitalActionName = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_GetStringForXboxOrigin = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_Init = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_Legacy_TriggerHapticPulse = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_Legacy_TriggerRepeatedHapticPulse = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_RunFrame = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_SetDualSenseTriggerEffect = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_SetInputActionManifestFilePath = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_SetLEDColor = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_ShowBindingPanel = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_Shutdown = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_StopAnalogActionMomentum = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_TranslateActionOrigin = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_TriggerSimpleHapticEvent = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_TriggerVibration = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInput_TriggerVibrationExtended = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInventory_AddPromoItem = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInventory_AddPromoItems = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInventory_CheckResultSteamID = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInventory_ConsumeItem = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInventory_DeserializeResult = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInventory_DestroyResult = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInventory_ExchangeItems = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInventory_GenerateItems = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInventory_GetAllItems = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInventory_GetEligiblePromoItemDefinitionIDs = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInventory_GetItemDefinitionIDs = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInventory_GetItemDefinitionProperty = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInventory_GetItemPrice = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInventory_GetItemsByID = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInventory_GetItemsWithPrices = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInventory_GetNumItemsWithPrices = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInventory_GetResultItemProperty = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInventory_GetResultItems = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInventory_GetResultStatus = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInventory_GetResultTimestamp = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInventory_GrantPromoItems = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInventory_InspectItem = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInventory_LoadItemDefinitions = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInventory_RemoveProperty = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInventory_RequestEligiblePromoItemDefinitionsIDs = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInventory_RequestPrices = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInventory_SendItemDropHeartbeat = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInventory_SerializeResult = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInventory_SetPropertyBool = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInventory_SetPropertyFloat = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInventory_SetPropertyInt64 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInventory_SetPropertyString = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInventory_StartPurchase = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInventory_StartUpdateProperties = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInventory_SubmitUpdateProperties = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInventory_TradeItems = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInventory_TransferItemQuantity = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamInventory_TriggerItemDrop = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmaking_AddFavoriteGame = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmaking_AddRequestLobbyListCompatibleMembersFilter = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmaking_AddRequestLobbyListDistanceFilter = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmaking_AddRequestLobbyListFilterSlotsAvailable = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmaking_AddRequestLobbyListNearValueFilter = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmaking_AddRequestLobbyListNumericalFilter = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmaking_AddRequestLobbyListResultCountFilter = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmaking_AddRequestLobbyListStringFilter = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmaking_CreateLobby = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmaking_DeleteLobbyData = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmaking_GetFavoriteGame = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmaking_GetFavoriteGameCount = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmaking_GetLobbyByIndex = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmaking_GetLobbyChatEntry = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmaking_GetLobbyData = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmaking_GetLobbyDataByIndex = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmaking_GetLobbyDataCount = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmaking_GetLobbyGameServer = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmaking_GetLobbyMemberByIndex = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmaking_GetLobbyMemberData = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmaking_GetLobbyMemberLimit = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmaking_GetLobbyOwner = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmaking_GetNumLobbyMembers = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmaking_InviteUserToLobby = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmaking_JoinLobby = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmaking_LeaveLobby = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmakingPingResponse_ServerFailedToRespond = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmakingPingResponse_ServerResponded = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmakingPlayersResponse_AddPlayerToList = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmakingPlayersResponse_PlayersFailedToRespond = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmakingPlayersResponse_PlayersRefreshComplete = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmaking_RemoveFavoriteGame = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmaking_RequestLobbyData = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmaking_RequestLobbyList = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmakingRulesResponse_RulesFailedToRespond = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmakingRulesResponse_RulesRefreshComplete = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmakingRulesResponse_RulesResponded = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmaking_SendLobbyChatMsg = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmakingServerListResponse_RefreshComplete = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmakingServerListResponse_ServerFailedToRespond = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmakingServerListResponse_ServerResponded = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmakingServers_CancelQuery = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmakingServers_CancelServerQuery = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmakingServers_GetServerCount = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmakingServers_GetServerDetails = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmakingServers_IsRefreshing = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmakingServers_PingServer = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmakingServers_PlayerDetails = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmakingServers_RefreshQuery = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmakingServers_RefreshServer = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmakingServers_ReleaseRequest = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmakingServers_RequestFavoritesServerList = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmakingServers_RequestFriendsServerList = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmakingServers_RequestHistoryServerList = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmakingServers_RequestInternetServerList = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmakingServers_RequestLANServerList = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmakingServers_RequestSpectatorServerList = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmakingServers_ServerRules = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmaking_SetLinkedLobby = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmaking_SetLobbyData = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmaking_SetLobbyGameServer = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmaking_SetLobbyJoinable = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmaking_SetLobbyMemberData = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmaking_SetLobbyMemberLimit = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmaking_SetLobbyOwner = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMatchmaking_SetLobbyType = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMusic_BIsEnabled = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMusic_BIsPlaying = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMusic_GetPlaybackStatus = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMusic_GetVolume = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMusic_Pause = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMusic_Play = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMusic_PlayNext = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMusic_PlayPrevious = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMusicRemote_BActivationSuccess = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMusicRemote_BIsCurrentMusicRemote = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMusicRemote_CurrentEntryDidChange = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMusicRemote_CurrentEntryIsAvailable = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMusicRemote_CurrentEntryWillChange = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMusicRemote_DeregisterSteamMusicRemote = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMusicRemote_EnableLooped = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMusicRemote_EnablePlaylists = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMusicRemote_EnablePlayNext = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMusicRemote_EnablePlayPrevious = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMusicRemote_EnableQueue = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMusicRemote_EnableShuffled = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMusicRemote_PlaylistDidChange = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMusicRemote_PlaylistWillChange = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMusicRemote_QueueDidChange = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMusicRemote_QueueWillChange = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMusicRemote_RegisterSteamMusicRemote = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMusicRemote_ResetPlaylistEntries = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMusicRemote_ResetQueueEntries = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMusicRemote_SetCurrentPlaylistEntry = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMusicRemote_SetCurrentQueueEntry = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMusicRemote_SetDisplayName = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMusicRemote_SetPlaylistEntry = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMusicRemote_SetPNGIcon_64x64 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMusicRemote_SetQueueEntry = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMusicRemote_UpdateCurrentEntryCoverArt = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMusicRemote_UpdateCurrentEntryElapsedSeconds = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMusicRemote_UpdateCurrentEntryText = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMusicRemote_UpdateLooped = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMusicRemote_UpdatePlaybackStatus = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMusicRemote_UpdateShuffled = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMusicRemote_UpdateVolume = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamMusic_SetVolume = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworking_AcceptP2PSessionWithUser = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworking_AllowP2PPacketRelay = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworking_CloseP2PChannelWithUser = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworking_CloseP2PSessionWithUser = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworking_CreateConnectionSocket = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworking_CreateListenSocket = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworking_CreateP2PConnectionSocket = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworking_DestroyListenSocket = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworking_DestroySocket = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingFakeUDPPort_DestroyFakeUDPPort = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingFakeUDPPort_ReceiveMessages = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingFakeUDPPort_ScheduleCleanup = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingFakeUDPPort_SendMessageToFakeIP = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworking_GetListenSocketInfo = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworking_GetMaxPacketSize = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworking_GetP2PSessionState = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworking_GetSocketConnectionType = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworking_GetSocketInfo = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworking_IsDataAvailable = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworking_IsDataAvailableOnSocket = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworking_IsP2PPacketAvailable = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingMessages_AcceptSessionWithUser = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingMessages_CloseChannelWithUser = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingMessages_CloseSessionWithUser = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingMessages_GetSessionConnectionInfo = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingMessages_ReceiveMessagesOnChannel = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingMessages_SendMessageToUser = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworking_ReadP2PPacket = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworking_RetrieveData = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworking_RetrieveDataFromSocket = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworking_SendDataOnSocket = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworking_SendP2PPacket = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_AcceptConnection = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_BeginAsyncRequestFakeIP = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_CloseConnection = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_CloseListenSocket = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_ConfigureConnectionLanes = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_ConnectByIPAddress = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_ConnectP2P = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_ConnectP2PCustomSignaling = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_ConnectToHostedDedicatedServer = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_CreateFakeUDPPort = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_CreateHostedDedicatedServerListenSocket = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_CreateListenSocketIP = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_CreateListenSocketP2P = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_CreateListenSocketP2PFakeIP = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_CreatePollGroup = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_CreateSocketPair = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_DestroyPollGroup = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_FindRelayAuthTicketForServer = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_FlushMessagesOnConnection = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_GetAuthenticationStatus = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_GetCertificateRequest = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_GetConnectionInfo = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_GetConnectionName = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_GetConnectionRealTimeStatus = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_GetConnectionUserData = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_GetDetailedConnectionStatus = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_GetFakeIP = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_GetGameCoordinatorServerLogin = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_GetHostedDedicatedServerAddress = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_GetHostedDedicatedServerPOPID = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_GetHostedDedicatedServerPort = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_GetIdentity = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_GetListenSocketAddress = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_GetRemoteFakeIPForConnection = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_InitAuthentication = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_ReceivedP2PCustomSignal = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_ReceivedRelayAuthTicket = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_ReceiveMessagesOnConnection = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_ReceiveMessagesOnPollGroup = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_ResetIdentity = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_RunCallbacks = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_SendMessages = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_SendMessageToConnection = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_SetCertificate = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_SetConnectionName = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_SetConnectionPollGroup = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingSockets_SetConnectionUserData = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingUtils_AllocateMessage = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingUtils_CheckPingDataUpToDate = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingUtils_ConvertPingLocationToString = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingUtils_EstimatePingTimeBetweenTwoLocations = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingUtils_EstimatePingTimeFromLocalHost = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingUtils_GetConfigValue = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingUtils_GetConfigValueInfo = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingUtils_GetDirectPingToPOP = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingUtils_GetIPv4FakeIPType = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingUtils_GetLocalPingLocation = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingUtils_GetLocalTimestamp = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingUtils_GetPingToDataCenter = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingUtils_GetPOPCount = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingUtils_GetPOPList = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingUtils_GetRealIdentityForFakeIP = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingUtils_GetRelayNetworkStatus = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingUtils_InitRelayNetworkAccess = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingUtils_IsFakeIPv4 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingUtils_IterateGenericEditableConfigValues = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingUtils_ParsePingLocationString = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingUtils_SetConfigValue = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingUtils_SetConfigValueStruct = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingUtils_SetConnectionConfigValueFloat = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingUtils_SetConnectionConfigValueInt32 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingUtils_SetConnectionConfigValueString = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingUtils_SetDebugOutputFunction = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingUtils_SetGlobalCallback_FakeIPResult = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingUtils_SetGlobalCallback_MessagesSessionFailed = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingUtils_SetGlobalCallback_MessagesSessionRequest = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingUtils_SetGlobalCallback_SteamNetAuthenticationStatusChanged = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingUtils_SetGlobalCallback_SteamNetConnectionStatusChanged = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingUtils_SetGlobalCallback_SteamRelayNetworkStatusChanged = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingUtils_SetGlobalConfigValueFloat = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingUtils_SetGlobalConfigValueInt32 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingUtils_SetGlobalConfigValuePtr = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingUtils_SetGlobalConfigValueString = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingUtils_SteamNetworkingIdentity_ParseString = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingUtils_SteamNetworkingIdentity_ToString = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingUtils_SteamNetworkingIPAddr_GetFakeIPType = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingUtils_SteamNetworkingIPAddr_ParseString = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamNetworkingUtils_SteamNetworkingIPAddr_ToString = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamParentalSettings_BIsAppBlocked = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamParentalSettings_BIsAppInBlockList = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamParentalSettings_BIsFeatureBlocked = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamParentalSettings_BIsFeatureInBlockList = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamParentalSettings_BIsParentalLockEnabled = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamParentalSettings_BIsParentalLockLocked = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamParties_CancelReservation = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamParties_ChangeNumOpenSlots = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamParties_CreateBeacon = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamParties_DestroyBeacon = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamParties_GetAvailableBeaconLocations = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamParties_GetBeaconByIndex = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamParties_GetBeaconDetails = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamParties_GetBeaconLocationData = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamParties_GetNumActiveBeacons = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamParties_GetNumAvailableBeaconLocations = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamParties_JoinParty = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamParties_OnReservationCompleted = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemotePlay_BGetSessionClientResolution = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemotePlay_BSendRemotePlayTogetherInvite = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemotePlay_BStartRemotePlayTogether = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemotePlay_GetSessionClientFormFactor = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemotePlay_GetSessionClientName = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemotePlay_GetSessionCount = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemotePlay_GetSessionID = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemotePlay_GetSessionSteamID = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_BeginFileWriteBatch = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_CommitPublishedFileUpdate = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_CreatePublishedFileUpdateRequest = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_DeletePublishedFile = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_EndFileWriteBatch = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_EnumeratePublishedFilesByUserAction = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_EnumeratePublishedWorkshopFiles = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_EnumerateUserPublishedFiles = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_EnumerateUserSharedWorkshopFiles = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_EnumerateUserSubscribedFiles = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_FileDelete = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_FileExists = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_FileForget = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_FilePersisted = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_FileRead = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_FileReadAsync = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_FileReadAsyncComplete = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_FileShare = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_FileWrite = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_FileWriteAsync = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_FileWriteStreamCancel = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_FileWriteStreamClose = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_FileWriteStreamOpen = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_FileWriteStreamWriteChunk = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_GetCachedUGCCount = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_GetCachedUGCHandle = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_GetFileCount = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_GetFileNameAndSize = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_GetFileSize = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_GetFileTimestamp = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_GetLocalFileChange = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_GetLocalFileChangeCount = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_GetPublishedFileDetails = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_GetPublishedItemVoteDetails = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_GetQuota = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_GetSyncPlatforms = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_GetUGCDetails = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_GetUGCDownloadProgress = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_GetUserPublishedItemVoteDetails = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_IsCloudEnabledForAccount = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_IsCloudEnabledForApp = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_PublishVideo = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_PublishWorkshopFile = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_SetCloudEnabledForApp = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_SetSyncPlatforms = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_SetUserPublishedFileAction = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_SubscribePublishedFile = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_UGCDownload = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_UGCDownloadToLocation = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_UGCRead = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_UnsubscribePublishedFile = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_UpdatePublishedFileDescription = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_UpdatePublishedFileFile = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_UpdatePublishedFilePreviewFile = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_UpdatePublishedFileSetChangeDescription = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_UpdatePublishedFileTags = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_UpdatePublishedFileTitle = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_UpdatePublishedFileVisibility = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamRemoteStorage_UpdateUserPublishedItemVote = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamScreenshots_AddScreenshotToLibrary = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamScreenshots_AddVRScreenshotToLibrary = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamScreenshots_HookScreenshots = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamScreenshots_IsScreenshotsHooked = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamScreenshots_SetLocation = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamScreenshots_TagPublishedFile = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamScreenshots_TagUser = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamScreenshots_TriggerScreenshot = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamScreenshots_WriteScreenshot = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamTimeline_AddGamePhaseTag = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamTimeline_AddInstantaneousTimelineEvent = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamTimeline_AddRangeTimelineEvent = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamTimeline_ClearTimelineTooltip = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamTimeline_DoesEventRecordingExist = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamTimeline_DoesGamePhaseRecordingExist = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamTimeline_EndGamePhase = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamTimeline_EndRangeTimelineEvent = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamTimeline_OpenOverlayToGamePhase = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamTimeline_OpenOverlayToTimelineEvent = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamTimeline_RemoveTimelineEvent = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamTimeline_SetGamePhaseAttribute = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamTimeline_SetGamePhaseID = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamTimeline_SetTimelineGameMode = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamTimeline_SetTimelineTooltip = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamTimeline_StartGamePhase = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamTimeline_StartRangeTimelineEvent = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamTimeline_UpdateRangeTimelineEvent = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_AddAppDependency = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_AddContentDescriptor = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_AddDependency = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_AddExcludedTag = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_AddItemKeyValueTag = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_AddItemPreviewFile = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_AddItemPreviewVideo = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_AddItemToFavorites = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_AddRequiredKeyValueTag = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_AddRequiredTag = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_AddRequiredTagGroup = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_BInitWorkshopForGameServer = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_CreateItem = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_CreateQueryAllUGCRequestCursor = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_CreateQueryAllUGCRequestPage = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_CreateQueryUGCDetailsRequest = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_CreateQueryUserUGCRequest = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_DeleteItem = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_DownloadItem = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_GetAppDependencies = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_GetItemDownloadInfo = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_GetItemInstallInfo = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_GetItemState = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_GetItemUpdateProgress = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_GetNumSubscribedItems = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_GetNumSupportedGameVersions = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_GetQueryFirstUGCKeyValueTag = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_GetQueryUGCAdditionalPreview = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_GetQueryUGCChildren = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_GetQueryUGCContentDescriptors = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_GetQueryUGCKeyValueTag = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_GetQueryUGCMetadata = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_GetQueryUGCNumAdditionalPreviews = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_GetQueryUGCNumKeyValueTags = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_GetQueryUGCNumTags = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_GetQueryUGCPreviewURL = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_GetQueryUGCResult = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_GetQueryUGCStatistic = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_GetQueryUGCTag = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_GetQueryUGCTagDisplayName = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_GetSubscribedItems = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_GetSupportedGameVersionData = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_GetUserContentDescriptorPreferences = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_GetUserItemVote = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_GetWorkshopEULAStatus = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_ReleaseQueryUGCRequest = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_RemoveAllItemKeyValueTags = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_RemoveAppDependency = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_RemoveContentDescriptor = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_RemoveDependency = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_RemoveItemFromFavorites = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_RemoveItemKeyValueTags = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_RemoveItemPreview = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_RequestUGCDetails = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_SendQueryUGCRequest = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_SetAdminQuery = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_SetAllowCachedResponse = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_SetAllowLegacyUpload = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_SetCloudFileNameFilter = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_SetItemContent = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_SetItemDescription = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_SetItemMetadata = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_SetItemPreview = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_SetItemTags = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_SetItemTitle = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_SetItemUpdateLanguage = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_SetItemVisibility = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_SetLanguage = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_SetMatchAnyTag = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_SetRankedByTrendDays = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_SetRequiredGameVersions = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_SetReturnAdditionalPreviews = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_SetReturnChildren = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_SetReturnKeyValueTags = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_SetReturnLongDescription = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_SetReturnMetadata = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_SetReturnOnlyIDs = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_SetReturnPlaytimeStats = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_SetReturnTotalOnly = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_SetSearchText = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_SetTimeCreatedDateRange = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_SetTimeUpdatedDateRange = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_SetUserItemVote = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_ShowWorkshopEULA = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_StartItemUpdate = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_StartPlaytimeTracking = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_StopPlaytimeTracking = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_StopPlaytimeTrackingForAllItems = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_SubmitItemUpdate = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_SubscribeItem = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_SuspendDownloads = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_UnsubscribeItem = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_UpdateItemPreviewFile = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUGC_UpdateItemPreviewVideo = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUser_AdvertiseGame = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUser_BeginAuthSession = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUser_BIsBehindNAT = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUser_BIsPhoneIdentifying = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUser_BIsPhoneRequiringVerification = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUser_BIsPhoneVerified = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUser_BIsTwoFactorEnabled = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUser_BLoggedOn = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUser_BSetDurationControlOnlineState = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUser_CancelAuthTicket = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUser_DecompressVoice = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUser_EndAuthSession = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUser_GetAuthSessionTicket = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUser_GetAuthTicketForWebApi = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUser_GetAvailableVoice = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUser_GetDurationControl = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUser_GetEncryptedAppTicket = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUser_GetGameBadgeLevel = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUser_GetHSteamUser = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUser_GetMarketEligibility = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUser_GetPlayerSteamLevel = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUser_GetSteamID = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUser_GetUserDataFolder = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUser_GetVoice = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUser_GetVoiceOptimalSampleRate = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUser_InitiateGameConnection_DEPRECATED = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUser_RequestEncryptedAppTicket = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUser_RequestStoreAuthURL = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUser_StartVoiceRecording = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_AttachLeaderboardUGC = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_ClearAchievement = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_DownloadLeaderboardEntries = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_DownloadLeaderboardEntriesForUsers = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_FindLeaderboard = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_FindOrCreateLeaderboard = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_GetAchievement = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_GetAchievementAchievedPercent = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_GetAchievementAndUnlockTime = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_GetAchievementDisplayAttribute = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_GetAchievementIcon = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_GetAchievementName = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_GetAchievementProgressLimitsFloat = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_GetAchievementProgressLimitsInt32 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_GetDownloadedLeaderboardEntry = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_GetGlobalStatDouble = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_GetGlobalStatHistoryDouble = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_GetGlobalStatHistoryInt64 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_GetGlobalStatInt64 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_GetLeaderboardDisplayType = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_GetLeaderboardEntryCount = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_GetLeaderboardName = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_GetLeaderboardSortMethod = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_GetMostAchievedAchievementInfo = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_GetNextMostAchievedAchievementInfo = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_GetNumAchievements = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_GetNumberOfCurrentPlayers = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_GetStatFloat = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_GetStatInt32 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_GetUserAchievement = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_GetUserAchievementAndUnlockTime = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_GetUserStatFloat = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_GetUserStatInt32 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_IndicateAchievementProgress = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_RequestGlobalAchievementPercentages = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_RequestGlobalStats = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_RequestUserStats = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_ResetAllStats = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_SetAchievement = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_SetStatFloat = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_SetStatInt32 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_StoreStats = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_UpdateAvgRateStat = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUserStats_UploadLeaderboardScore = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUser_StopVoiceRecording = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUser_TerminateGameConnection_DEPRECATED = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUser_TrackAppUsageEvent = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUtils_BOverlayNeedsPresent = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUtils_CheckFileSignature = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUtils_DismissFloatingGamepadTextInput = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUtils_DismissGamepadTextInput = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUtils_FilterText = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUtils_GetAPICallFailureReason = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUtils_GetAPICallResult = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUtils_GetAppID = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUtils_GetConnectedUniverse = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUtils_GetCurrentBatteryPower = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUtils_GetEnteredGamepadTextInput = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUtils_GetEnteredGamepadTextLength = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUtils_GetImageRGBA = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUtils_GetImageSize = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUtils_GetIPCCallCount = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUtils_GetIPCountry = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUtils_GetIPv6ConnectivityState = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUtils_GetSecondsSinceAppActive = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUtils_GetSecondsSinceComputerActive = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUtils_GetServerRealTime = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUtils_GetSteamUILanguage = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUtils_InitFilterText = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUtils_IsAPICallCompleted = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUtils_IsOverlayEnabled = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUtils_IsSteamChinaLauncher = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUtils_IsSteamInBigPictureMode = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUtils_IsSteamRunningInVR = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUtils_IsSteamRunningOnSteamDeck = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUtils_IsVRHeadsetStreamingEnabled = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUtils_SetGameLauncherMode = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUtils_SetOverlayNotificationInset = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUtils_SetOverlayNotificationPosition = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUtils_SetVRHeadsetStreamingEnabled = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUtils_SetWarningMessageHook = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUtils_ShowFloatingGamepadTextInput = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUtils_ShowGamepadTextInput = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamUtils_StartVRDashboard = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamVideo_GetOPFSettings = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamVideo_GetOPFStringForApp = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamVideo_GetVideoURL = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ISteamVideo_IsBroadcasting = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ManualDispatch_FreeLastCallback = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ManualDispatch_GetAPICallResult = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ManualDispatch_GetNextCallback = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ManualDispatch_Init = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ManualDispatch_RunFrame = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_MatchMakingKeyValuePair_t_Construct = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_RegisterCallback = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_RegisterCallResult = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_ReleaseCurrentThreadMemory = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_RestartAppIfNecessary = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_RunCallbacks = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_servernetadr_t_Assign = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_servernetadr_t_Construct = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_servernetadr_t_GetConnectionAddressString = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_servernetadr_t_GetConnectionPort = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_servernetadr_t_GetIP = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_servernetadr_t_GetQueryAddressString = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_servernetadr_t_GetQueryPort = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_servernetadr_t_Init = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_servernetadr_t_IsLessThan = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_servernetadr_t_SetConnectionPort = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_servernetadr_t_SetIP = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_servernetadr_t_SetQueryPort = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SetBreakpadAppID = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SetMiniDumpComment = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SetTryCatchCallbacks = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_Shutdown = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamApps_v008 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamController_v008 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamDatagramHostedAddress_Clear = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamDatagramHostedAddress_GetPopID = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamDatagramHostedAddress_SetDevAddress = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamFriends_v017 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamGameSearch_v001 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamGameServerHTTP_v003 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamGameServerInventory_v003 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamGameServerNetworkingMessages_SteamAPI_v002 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamGameServerNetworkingSockets_SteamAPI_v012 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamGameServerNetworking_v006 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamGameServerStats_v001 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamGameServerUGC_v020 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamGameServerUtils_v010 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamGameServer_v015 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamHTMLSurface_v005 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamHTTP_v003 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamInput_v006 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamInventory_v003 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamIPAddress_t_IsSet = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamMatchmakingServers_v002 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamMatchmaking_v009 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamMusicRemote_v001 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamMusic_v001 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingConfigValue_t_SetFloat = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingConfigValue_t_SetInt32 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingConfigValue_t_SetInt64 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingConfigValue_t_SetPtr = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingConfigValue_t_SetString = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingIdentity_Clear = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingIdentity_GetFakeIPType = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingIdentity_GetGenericBytes = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingIdentity_GetGenericString = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingIdentity_GetIPAddr = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingIdentity_GetIPv4 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingIdentity_GetPSNID = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingIdentity_GetSteamID = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingIdentity_GetSteamID64 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingIdentity_GetXboxPairwiseID = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingIdentity_IsEqualTo = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingIdentity_IsFakeIP = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingIdentity_IsInvalid = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingIdentity_IsLocalHost = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingIdentity_ParseString = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingIdentity_SetGenericBytes = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingIdentity_SetGenericString = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingIdentity_SetIPAddr = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingIdentity_SetIPv4Addr = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingIdentity_SetLocalHost = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingIdentity_SetPSNID = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingIdentity_SetSteamID = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingIdentity_SetSteamID64 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingIdentity_SetXboxPairwiseID = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingIdentity_ToString = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingIPAddr_Clear = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingIPAddr_GetFakeIPType = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingIPAddr_GetIPv4 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingIPAddr_IsEqualTo = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingIPAddr_IsFakeIP = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingIPAddr_IsIPv4 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingIPAddr_IsIPv6AllZeros = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingIPAddr_IsLocalHost = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingIPAddr_ParseString = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingIPAddr_SetIPv4 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingIPAddr_SetIPv6 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingIPAddr_SetIPv6LocalHost = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingIPAddr_ToString = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingMessages_SteamAPI_v002 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingMessage_t_Release = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingSockets_SteamAPI_v012 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworkingUtils_SteamAPI_v004 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamNetworking_v006 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamParentalSettings_v001 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamParties_v002 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamRemotePlay_v002 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamRemoteStorage_v016 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamScreenshots_v003 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamTimeline_v004 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamUGC_v020 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamUserStats_v013 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamUser_v023 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamUtils_v010 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_SteamVideo_v007 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_UnregisterCallback = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_UnregisterCallResult = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_UseBreakpadCrashHandler = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamAPI_WriteMiniDump = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamClient = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamGameServer_BSecure = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamGameServer_GetHSteamPipe = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamGameServer_GetHSteamUser = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamGameServer_GetIPCCallCount = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamGameServer_GetSteamID = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamGameServer_InitSafe = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamGameServer_RunCallbacks = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamGameServer_Shutdown = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamInternal_ContextInit = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamInternal_CreateInterface = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamInternal_FindOrCreateGameServerInterface = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamInternal_FindOrCreateUserInterface = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamInternal_GameServer_Init_V2 = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamInternal_SteamAPI_Init = NULL;
__attribute__((visibility("hidden"))) void *_fwd_SteamRealPath = NULL;
__attribute__((visibility("hidden"))) void *_fwd___wrap_access = NULL;
__attribute__((visibility("hidden"))) void *_fwd___wrap_chdir = NULL;
__attribute__((visibility("hidden"))) void *_fwd___wrap_chmod = NULL;
__attribute__((visibility("hidden"))) void *_fwd___wrap_chown = NULL;
__attribute__((visibility("hidden"))) void *_fwd___wrap_dlmopen = NULL;
__attribute__((visibility("hidden"))) void *_fwd___wrap_dlopen = NULL;
__attribute__((visibility("hidden"))) void *_fwd___wrap_fopen = NULL;
__attribute__((visibility("hidden"))) void *_fwd___wrap_fopen64 = NULL;
__attribute__((visibility("hidden"))) void *_fwd___wrap_freopen = NULL;
__attribute__((visibility("hidden"))) void *_fwd___wrap_lchown = NULL;
__attribute__((visibility("hidden"))) void *_fwd___wrap_link = NULL;
__attribute__((visibility("hidden"))) void *_fwd___wrap_lstat = NULL;
__attribute__((visibility("hidden"))) void *_fwd___wrap_lstat64 = NULL;
__attribute__((visibility("hidden"))) void *_fwd___wrap___lxstat = NULL;
__attribute__((visibility("hidden"))) void *_fwd___wrap___lxstat64 = NULL;
__attribute__((visibility("hidden"))) void *_fwd___wrap_mkdir = NULL;
__attribute__((visibility("hidden"))) void *_fwd___wrap_mkfifo = NULL;
__attribute__((visibility("hidden"))) void *_fwd___wrap_mknod = NULL;
__attribute__((visibility("hidden"))) void *_fwd___wrap_mount = NULL;
__attribute__((visibility("hidden"))) void *_fwd___wrap_open = NULL;
__attribute__((visibility("hidden"))) void *_fwd___wrap_open64 = NULL;
__attribute__((visibility("hidden"))) void *_fwd___wrap_opendir = NULL;
__attribute__((visibility("hidden"))) void *_fwd___wrap_rename = NULL;
__attribute__((visibility("hidden"))) void *_fwd___wrap_rmdir = NULL;
__attribute__((visibility("hidden"))) void *_fwd___wrap_scandir = NULL;
__attribute__((visibility("hidden"))) void *_fwd___wrap_scandir64 = NULL;
__attribute__((visibility("hidden"))) void *_fwd___wrap_stat = NULL;
__attribute__((visibility("hidden"))) void *_fwd___wrap_stat64 = NULL;
__attribute__((visibility("hidden"))) void *_fwd___wrap_statfs = NULL;
__attribute__((visibility("hidden"))) void *_fwd___wrap_statfs64 = NULL;
__attribute__((visibility("hidden"))) void *_fwd___wrap_statvfs = NULL;
__attribute__((visibility("hidden"))) void *_fwd___wrap_statvfs64 = NULL;
__attribute__((visibility("hidden"))) void *_fwd___wrap_symlink = NULL;
__attribute__((visibility("hidden"))) void *_fwd___wrap_unlink = NULL;
__attribute__((visibility("hidden"))) void *_fwd___wrap_utime = NULL;
__attribute__((visibility("hidden"))) void *_fwd___wrap_utimes = NULL;
__attribute__((visibility("hidden"))) void *_fwd___wrap___xstat = NULL;
__attribute__((visibility("hidden"))) void *_fwd___wrap___xstat64 = NULL;
